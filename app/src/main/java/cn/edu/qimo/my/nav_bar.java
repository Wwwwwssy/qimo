...
public class nav_bar extends LinearLayout  {
    ...
    public nav_bar(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public nav_bar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public nav_bar(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
